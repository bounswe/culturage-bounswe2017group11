...
class CommentList(APIView):
	## API endpoint that creates comment
	# @param request for comment list
	# @param itemID for adding comment to item
	...
	## API endpoint that get comments of the item
	# @param request for comment list
	# @param itemID for getting comment of the item
...
## API endpoint for timelines
class ItemTimeline(APIView):
	## API endpoint that creates timelines
	# @param request for timeline list
	# @param itemID for adding timeline to item
	def post(self, request, itemID):
		item = Item.objects.get(id=itemID)
		user = request.user
	...
	## API endpoint that get timelines of the item
	# @param request for timeline list
	# @param itemID for getting timelines of the item
	def get(self, request, itemID):
		item = Item.objects.get(id=itemID)
